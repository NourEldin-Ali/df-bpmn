...
public class S13 {
	private static Logger logger = Logger.getLogger(S13.class.getName());
	...
	public void testInputProcess() throws BPMNModelException, CloneNotSupportedException {
		logger.info("s13.bpmn done: Start generating model");
		String path = "src/test/resources/discovery/loop/s13_results.bpmn";
