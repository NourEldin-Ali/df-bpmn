 ...
 *
 */
public class TestReadModifyDataObject {

    private static Logger logger = Logger.getLogger(TestReadModifyDataObject.class.getName());
     ...
     */
    @Test
    public void testReadAndModifyModel() throws BPMNModelException {

        logger.info("...read model");

        BPMNModel model = BPMNModelFactory.read("/data-add.bpmn");
...
//        System.out.println();
        ...
        String out = "src/test/resources/data-read-update.bpmn";
        model.save(out);
