...
public class App2 {
	...
	public static void main(String[] args) throws BPMNModelException {
//		if (args.length ==2) {
        Path path = Paths.get("C:\\Users\\AliNourEldin\\Desktop\\nala2bpmn-piplines\\promoai\\utils\\evaluation\\results\\gpt-4-turbo\\doc-1.3-gpt-4-turbo-2.bpmn"); // Change this to your directory path
        BPMNModel model = BPMNModelFactory.read(path.toString());
